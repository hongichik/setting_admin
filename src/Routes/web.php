...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'liondev\setting_admin\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'liondev\setting_admin\Controllers', 'middleware' => 'web'], function () {
