...
<html lang="vn">
    ...
    <body>
        <div class="master">
            <div class="box">
                <div class="header">
                    <img src="{{ asset('installer/img/lion-5.ico') }}" style="width: 120px;" alt="">
                    <h1 class="header__title">@yield('title')</h1>
                </div>
                <ul class="step">
                    <li class="step__divider"></li>
                    <li class="step__item {{ request()->is('install/final') ? 'active' : '' }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ request()->is('install/environment') ? 'active' : '' }}{{ request()->is('install/environment/wizard') ? 'active' : '' }}{{ request()->is('install/environment/classic') ? 'active' : '' }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ request()->is('install/permissions') ? 'active' : '' }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ request()->is('install/requirements') ? 'active' : '' }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ request()->is('install') ? 'active' : '' }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
